        ...
        <main class="main_popup_container">
            <div class="main_popup">
                ...
                <div class="popup_contenu" id="div_page1">
                    ...
                    <div>
                        <div class="label_img_input no-margin-top ">
                            <input class="input_field btn-show key" id="question1" name="question1" type="text" placeholder="Quelle est le nom de votre premier animale de compagnie ?" autocomplete="off" minlength="1">
                        </div>
                        <div class="label_img_input no-margin-top">
                ...
                <div class="popup_contenu hidden" id="div_page2">
                    ...
                    <div>
                        <div class="label_img_input no-margin-top ">
                            <input class="input_field btn-show key" id="question2" name="question2" type="text" placeholder="Quelle est le nom de votre mère ?" autocomplete="off" minlength="1">
                        </div>
                        <div class="label_img_input no-margin-top">
                ...
                <div class="popup_contenu hidden" id="div_page3">
                    ...
                    <form>
                    <div class="label_img_input no-margin-top ">
                            <input class="input_field btn-show key" id="question3" name="question3" type="text" placeholder="Quelle est le nom de votre meilleur(e) ami(e) ?" autocomplete="off" minlength="1">
                        </div>
                        <div class="label_img_input no-margin-top">
