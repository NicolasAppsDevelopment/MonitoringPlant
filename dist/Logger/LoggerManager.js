...
const createAppLogger = () => {
    ...
    let logger = (0, winston_1.createLogger)({
        ...
        transports: [
            new winston_1.transports.File({ filename: loggerPath + 'error.log', level: 'error' }),
            new winston_1.transports.File({ filename: loggerPath + 'combined.log' }),
        ...
        exceptionHandlers: [
            new winston_1.transports.File({ filename: loggerPath + 'exceptions.log' })
        ]
    });
