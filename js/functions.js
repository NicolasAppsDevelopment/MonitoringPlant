...
async function displayConfirm(title, msg, confirmBtnTitle, destructive = false) {
    ...
    const html_popup = `
        <div class="popup visible" id="confirm_popup_container${id}">
            <div id="confirm_popup${id}" class="popup-inner blur">    
    ...
    setTimeout(() => {
        document.getElementById("confirm_popup_container" + id).style.opacity = 1;
        document.getElementById("confirm_popup" + id).style.transform = "scale(1)";
    }, 10);
...
async function hideConfirm(id) {
    ...
    document.getElementById("confirm_popup" + id).style.transform = "scale(0.95)";
...
async function displayError(title, msg) {
    ...
    const html_popup = `
        <div class="popup visible" id="error_popup_container${id}">
            <div id="error_popup${id}" class="popup-inner blur">    
                <div class="popup-content center">
                    ...
                    <div class="actions_msgbox">
                        <button id="close${id}" class="rect_round_btn gray" type="button">OK</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    setTimeout(() => {
        document.getElementById("error_popup_container" + id).style.opacity = 1;
        document.getElementById("error_popup" + id).style.transform = "scale(1)";
    }, 10);
...
async function hideError(id) {
    ...
    popup_container.style.opacity = 0;
    document.getElementById("error_popup" + id).style.transform = "scale(0.95)";
