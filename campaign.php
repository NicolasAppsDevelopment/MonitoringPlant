    ...
    <main>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="status-actions" id="actionBar">
                    <?php if ($session->isAdmin()) { ?>
                        <button class="status-action-container restart" onclick="restartCampaign()" id="restart_btn">
                    ...
                    <?php } ?>
                    <button class="status-action-container stop" onclick="stopCampaign()" id="stop_btn">
        ...
        <div class="popup">
            <div class="popup-inner">
                ...
                <div class="popup-content">
                    ...
                    <button id="btn_dwld" class="rect_round_btn gray" onclick="exportCampaign()">Télécharger</button>
                </div>
            </div>
        </div>
    </main>
